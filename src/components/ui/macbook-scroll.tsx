...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[100vh]  flex flex-col items-center py-0 md:py-48 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.7] sm:scale-90"
    >
      <motion.h2
        style={{
